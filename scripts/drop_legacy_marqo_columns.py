...
was superseded by a generically-named vector_doc_id column, backfilled once
at startup (see pipeline/db.py init_db()). marqo_doc_id has been left in
    ...
    with db.get_connection() as conn:
        ...
        if stale:
            print(
                ...
                "marqo_doc_id set but vector_doc_id NULL — the backfill in "
        ...
        print(f"document_index_status: {total} row(s), all backfilled to vector_doc_id.")
